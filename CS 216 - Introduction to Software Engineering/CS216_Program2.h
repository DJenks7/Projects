...
struct listnode {
	string text;								// String used to hold the line of text in each section of the linked list.
...
private:
	...
	void InsertTail(string thing);				// Function to insert a new line of text at the end of the linked list.
...
void Llist::Initalize() {
	string line;
	ifstream myfile("CS216_Program2.txt");
